            ...
            <div class="card">
                <div class="card bg-white color-black" id="card-master">
                    <div class="card-header card-header-info">
                        <h4 class="card-title">Upload Clean Data</h4>
                        <p class="card-category">Upload Terlebih Dahulu Data Hasil Dari Preprocessing</p>
                    </div>
                    <div class="card-body ">
                                            ...
                                            <div id="container">
                                                <form method="post" enctype="multipart/form-data" novalidate="" class="box has-advanced-upload">
                                                    <div class="box-input">
                                                        ...
                                                        <input type="file" name="file_import_db" id="file" class="box-file">
                                                        <label for="file"><strong>Choose a file</strong><span class="box-dragndrop"> or drag it here</span>.</label>
                                                        <button type="button" id="form-import-db" class="button">Upload</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
