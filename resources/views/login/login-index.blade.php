                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input name="code_unix" required type="text" autocomplete="off" class="form-control" placeholder="Nomor Unix" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
...
<script type="text/javascript" src="{{asset('sentiment/js/login/post-login.js')}}"></script>
</body>
</html>