...
$(document).ready(function() {
	...
	$('.xs-countdown-timer[data-countdown]').each(function() {
		var $this = $(this), 
			...
			+ '<span class="timer-count">%-D <span class="timer-text">Hari</span></span>  ' 
	...
	$('.xs-countdown-timer-v2[data-countdown]').each(function() {
		var $this = $(this), 
			...
			$this.countdown(finalDate, function(event) {
			var $this = $(this).html(event.strftime(' ' 
			+ '<div class="xs-timer-container"><span class="timer-count">%-D </span><span class="timer-text">Hari</span></div>'
			+ '<div class="xs-timer-container"><span class="timer-count">%H </span><span class="timer-text">Jam</span></div>' 
			+ '<div class="xs-timer-container"><span class="timer-count">%M </span><span class="timer-text">Menit</span></div>' 
			+ '<div class="xs-timer-container"><span class="timer-count">%S </span><span class="timer-text">Detik</span></div>'));
		});
	});
